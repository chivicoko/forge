...
export default function OrderTrackingPage() {
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground text-sm mb-6">
            Track your deliveries and order history from one place.
          </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pb-10 pt-24">
      <div className="mb-8">
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {orders.map((order) => (
            <div
              key={order.id}
              className="bg-background border rounded-2xl p-5 hover:border-amber-500/50 transition-colors"
            >
              <div className="flex items-center justify-between flex-wrap gap-3 mb-3">
                ...
                <div className="flex items-center gap-3">
                  <Badge
                    variant={
                      statusVariant[order.status?.toLowerCase()] ?? "default"
                    }
              ...
              <div className="grid sm:grid-cols-2 gap-2 text-sm text-muted-foreground border-t pt-3">
                <div>
                  <span className="text-xs uppercase tracking-wide font-semibold text-foreground/50">
                    Delivery Address
                  </span>
